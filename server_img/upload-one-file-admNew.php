...
$log = $connection->real_escape_string($_POST["title"]);
$sname = $connection->real_escape_string($_POST["subject"]);
$name = $connection->real_escape_string($_POST["author"]);
...
$desc = $connection->real_escape_string($_POST["desc"]);
    ...
    $sql = "INSERT INTO `news` (`title`, `descr`, `img`, `img1`, `author`, `date`, `description1`) VALUES('$log', '$sname', '$img', '$col', '$name', '$date','$desc')"; 
