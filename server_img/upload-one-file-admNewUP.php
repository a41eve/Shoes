...
$product = mysqli_query($connection, "SELECT * FROM `news` WHERE `id_ns` = '$polz'" );
...
$description1 = $connection->real_escape_string($_POST["description1"]);
    ...
    $sql = "UPDATE `news` SET `title`='$title', `descr`='$descr', `img`='$img', `img1`='$imgs', `author`='$author', `description1`='$description1' WHERE `id_ns` = '$polz'"; 
